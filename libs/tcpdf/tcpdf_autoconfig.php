...
if (!defined('K_TCPDF_EXTERNAL_CONFIG') OR ! K_TCPDF_EXTERNAL_CONFIG) {
    ...
    $tcpdf_config_files = array(dirname(__FILE__) . '/config/tcpdf_config.php', '/etc/php-tcpdf/tcpdf_config.php',
        '/etc/tcpdf/tcpdf_config.php', '/etc/tcpdf_config.php');
...
if (!defined('K_PATH_IMAGES')) {
    $tcpdf_images_dirs = array(K_PATH_MAIN . 'images/', K_PATH_MAIN . 'examples/images/',
        '/usr/share/doc/php-tcpdf/examples/images/', '/usr/share/doc/tcpdf/examples/images/',
        '/usr/share/doc/php/tcpdf/examples/images/', '/var/www/tcpdf/images/', '/var/www/html/tcpdf/images/',
...
if (!defined('PDF_HEADER_LOGO')) {
    $tcpdf_header_logo = 'logo-ayto.jpg';
