            ...
            <div class="row col-md-12">
                    ...
                    <div class="form-group ">
                        ...
                        <div class="col-md-9">
                            <div class="input-group">
                                <span class="input-group-addon glyphicon glyphicon-globe"></span>
                                <input type="text" class="form-control" name="coordenadas" id="coordenadas" placeholder="Coordenadas" value="{$datos.coordenadas|default:''}">
                            </div>
                        </div>
                    </div>                            
                    ...
                    <div class="form-group ">
                        ...
                        <div class="col-md-9">
                            <div class="input-group">
                                <span class="input-group-addon glyphicon glyphicon-globe"></span>
                                <input type="text" class="form-control" name="mapa" id="direccion" placeholder="mapa" value="{$datos.mapa|default:''}">
                            </div>
                        </div>
                    </div>
