<div class="text-center well well-sm pagination-well">
<ul class="pagination">
...
<?php endif; ?>
        <hr/>
    <small class="text-info"> P&aacute;gina 
        <?php echo $this->_paginacion['actual'] ?>
        de 
        <?php echo $this->_paginacion['total'] ?></small>
</div>
</ul>
