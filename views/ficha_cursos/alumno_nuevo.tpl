<div class="row">
    <div class="well well-sm col-md-6 col-md-push-3">
        ...
        <form role="form" class="form-horizontal" action="{BASE_URL}ficha_cursos/crearAlumno/{$id_ficha_curso}/{$datos.dni}" method="post">     
            <input type="hidden" name="guardar_nuevo" value="1" />
            <input type="hidden" name="dni" value="{$datos.dni|default:''}" />
                    ...
                    <div class="col-md-9">
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" {*name="dni" id="dni" placeholder="DNI" *}
                                   value="{$datos.dni|default:''}" disabled>
                        </div>
                    </div>
                </div>
                <div class="form-group ">
                ...
                <div class="form-group ">
                    ...
                    <div class="col-md-9">
                        <div class="input-group">
                            ...
                            <input type="date" class="form-control" name="fechaNac" id="fechaNac" placeholder="aaaa-mm-dd" value="{$datos.fechaNac|default:''}">
                        </div>
                    </div>
                </div>
                <div class="form-group ">
