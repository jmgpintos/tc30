                ...
                <div class="form-group ">
                    ...
                    <div class="col-md-9">
                        <div class="input-group">
                            ...
                            <input type="date" class="form-control" name="fecha_nacimiento" id="fecha_nacimiento" placeholder="Fecha de nacimiento" value="{$datos.fecha_nacimiento|default:''}">
                        </div>
                    </div>
                </div>
                <div class="form-group ">
                    ...
                    <div class="col-md-9">
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" name="telefono" id="telefono" placeholder="Teléfono" value="{$datos.telefono}">
                        </div>
                    </div>
                </div>
                <div class="form-group ">
...
{*                            <span class="input-group-addon glyphicon glyphicon-"></span>*}
                            <input type="text" class="form-control" name="email" id="email" placeholder="Correo electrónico" value="{$datos.email}">
                        </div>
                    </div>
                </div>
